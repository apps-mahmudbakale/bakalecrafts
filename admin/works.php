...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- /.card -->
      <form action="" method="POST" id="workForm" enctype="Multipart/form-data">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">New Work</h3>
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                <label for="inputName">Work Name</label>
                <input type="text" id="Name" name="name" class="form-control">
              </div>
              <div class="col-md-6">
                <label for="inputProjectLeader">Work Caption</label>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Create new work" id="submitBtn" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
  ...
  $(document).ready(()=>{
    $('#workForm').on('submit', ((e)=>{
        ...
        $.ajax({
            type: 'POST',
            url: '../api/addWork.php',
            data: new FormData(document.getElementById('workForm')),
            dataType: 'json',
            contentType: false,
            cache: false,
            processData: false,
            beforeSend: (()=>{
              ...
              $('#workForm').css("opacity",".5");
            }), 
            success: ((response)=>{
              //console.log(response);
              $('#submitBtn').removeAttr("disabled");
              $('#workForm').css("opacity","");
