    ...
    <section class="content">
       ...
       <?php 
        if (isset($_GET['id'])) {
          ...
          $id = base64_decode($_GET['id']);
            mysqli_query($db,"DELETE FROM board_directors WHERE id ='$id'");
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Board of Directors</h3>
            ...
            <thead>
              ...
              <tbody>
                 ...
                 while ($row = mysqli_fetch_array($query)) {
                  ...
                  <td><img alt="Avatar" class="table-avatar" src="../assets/img/board/<?php echo $row['image'] ?>"></td>
                  <td><?php echo $row['phone'] ?></td>
                  <td><?php echo $row['rank'] ?></td>
                  <td class="project-actions text-right">
                      <a class="btn btn-info btn-sm" href="boardEdit.php?id=<?php echo base64_encode($row[id]);?>">
        ...
        if (isset($_POST['submitBtn'])) {
            ...
            if (in_array($fileType, $allowTypes)) {
              ...
              if (move_uploaded_file($_FILES['file']['tmp_name'], $targetFilePath)) {
                ...
                mysqli_query($db,"INSERT INTO `board_directors`(`id`, `name`, `rank`, `phone`, `image`) VALUES (NULL,'$name','$rank','$phone','$uploadFile')");
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">New Board Member</h3>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Add new member" name="submitBtn" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
