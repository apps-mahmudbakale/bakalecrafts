    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="catalogue.php" class="nav-link active">
    ...
    <section class="content">
        ...
        <div class="card-body p-0">
          <table class="table table-striped projects">
            <thead>
              ...
              <tbody>
                <?php if (file_exists('../assets/Catalogue.pdf')): ?>
                  <tr>
                  <td><a href="../assets/Catalogue.pdf" download class="btn btn-primary btn-block">Download Catalogue</a></td>
                  <td class="project-actions text-right">
                      <a class="btn btn-danger btn-sm" href="?delete=yes">
      ...
      <?php 
        ...
        if (isset($_POST['submitBtn'])) {
            ...
            if (in_array($fileType, $allowTypes)) {
              ...
              if (move_uploaded_file($_FILES['file']['tmp_name'], $uploadDir.'Catalogue.'.$fileType)) {
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">New Catalogue</h3>
            ...
            <div class="card-body">
              ...
              <div class="col-md-12">
                <label for="inputName">Catalogue File</label>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Upload new Catalogue" name="submitBtn" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
