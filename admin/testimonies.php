...
if (isset($_GET['id'])) {
  ...
  $id = base64_decode($_GET['id']);
    mysqli_query($db,"DELETE FROM testimonies WHERE id ='$id'");
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">New Testimony</h3>
            ...
            <div class="card-body">
              ...
              <div class="col-md-12">
                ...
                <textarea  id="Testimony" name="testimony" class="form-control"></textarea>
              </div>
              </div>
            </div>
            <!-- /.card-body -->
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Add new testimony" id="submitBtn" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
...
<script>
  var testimony = new App();
  testimony.testimonyList();
  $(document).ready(()=>{
    $('#testimonyForm').on('submit', ((e)=>{
        e.preventDefault();
        $.ajax({
            type: 'POST',
            url: '../api/addTestimony.php',
            data: new FormData(document.getElementById('testimonyForm')),
            dataType: 'json',
            contentType: false,
            cache: false,
            processData: false,
