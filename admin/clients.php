    ...
    <section class="content">
       ...
       <?php 
        if (isset($_GET['id'])) {
          ...
          $id = base64_decode($_GET['id']);
            mysqli_query($db,"DELETE FROM clients WHERE id ='$id'");
            ...
            <thead>
              ...
              <tbody>
                 ...
                 while ($row = mysqli_fetch_array($query)) {
                  ...
                  <td><img alt="Avatar" class="table-avatar" src="../assets/img/clients/<?php echo $row['image'] ?>"></td>
        ...
        if (isset($_POST['submitBtn'])) {
            ...
            if (in_array($fileType, $allowTypes)) {
              ...
              if (move_uploaded_file($_FILES['file']['tmp_name'], $targetFilePath)) {
                ...
                $magicianObj -> resizeImage(400, 142);
                    $uploadFile = time().'.'.$fileType;
                  $magicianObj -> saveImage($clientDir.$uploadFile, 100);
                  unlink($targetFilePath);
                mysqli_query($db,"INSERT INTO `clients`(`id`, `name`, `image`) VALUES (NULL,'$name','$uploadFile')");
      ...
      <div class="row">
        <div class="col-12">
          ...
          <input type="submit" value="Add new Client" name="submitBtn" class="btn btn-success float-right">
        </div>
      </div>
    </form>
    </section>
