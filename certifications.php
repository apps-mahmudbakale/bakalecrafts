    ...
    <div class="container d-flex" style="max-width: 1417px">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="active"><a href="certifications.php">Certifications</a></li>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2 data-aos="fade-in">Certifications</h2>
        </div>
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-6 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/certificates/<?php echo $row['image'] ?>" class="img-fluid" alt="">
              <div class="portfolio-links">
                <a href="assets/img/certificates/<?php echo $row['image'] ?>" data-gall="portfolioGallery" class="venobox" title="<?php echo $row['name'] ?>"><i class="icofont-plus-circle"></i></a>
